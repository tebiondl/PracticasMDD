...
namespace UPM_IPS.MBRDCMDMI_ProyectoIPS.MBRDCMDMI
{
	...
	/// </summary>
	internal partial class MBRDCMDMICommandSet : MBRDCMDMICommandSetBase
	{
		/// <summary>
		/// Constructs a new MBRDCMDMICommandSet.
		/// </summary>
		public MBRDCMDMICommandSet(global::System.IServiceProvider serviceProvider) 
	...
	/// </summary>
	internal abstract class MBRDCMDMICommandSetBase : DslShell::CommandSet
	{
		/// <summary>
		/// Constructs a new MBRDCMDMICommandSetBase.
		/// </summary>
		protected MBRDCMDMICommandSetBase(global::System.IServiceProvider serviceProvider) : base(serviceProvider)
		{
		}
		...
		protected override global::System.Collections.Generic.IList<global::System.ComponentModel.Design.MenuCommand> GetMenuCommands()
		{
			...
			menuCommand = new DslShell::CommandContextBoundMenuCommand(this.ServiceProvider,
				...
				Constants.ViewMBRDCMDMIExplorerCommand,
				typeof(MBRDCMDMIEditorFactory).GUID);
		...
		{
			MBRDCMDMIExplorerToolWindow explorer = this.MBRDCMDMIExplorerToolWindow;
			if (explorer != null)
			{
				explorer.Show();
			}
		...
		protected MBRDCMDMIDocData CurrentMBRDCMDMIDocData
		{
			get
			{
				return this.MonitorSelection.CurrentDocument as MBRDCMDMIDocData;
			}
		}
		...
		/// </summary>
		[global::System.Diagnostics.CodeAnalysis.SuppressMessage("Microsoft.Performance", "CA1811:AvoidUncalledPrivateCode")]
		protected MBRDCMDMIDocView CurrentMBRDCMDMIDocView
		{
			get
			{
				return this.MonitorSelection.CurrentDocumentView as MBRDCMDMIDocView;
			}
		}
		...
		/// </summary>
		protected MBRDCMDMIExplorerToolWindow MBRDCMDMIExplorerToolWindow
		{
			get
			{
				MBRDCMDMIExplorerToolWindow explorerWindow = null;
				DslShell::ModelingPackage package = this.ServiceProvider.GetService(typeof(VSShell::Package)) as DslShell::ModelingPackage;

				if (package != null)
				{
					explorerWindow = package.GetToolWindow(typeof(MBRDCMDMIExplorerToolWindow), true) as MBRDCMDMIExplorerToolWindow;
				}
		...
		protected object ExplorerSelection
		{
			get
			{
				...
				MBRDCMDMIExplorerToolWindow explorerWindow = this.MBRDCMDMIExplorerToolWindow;
	...
	/// Double-derived class to allow easier code customization.
	/// </summary>
	internal partial class MBRDCMDMIClipboardCommandSet : MBRDCMDMIClipboardCommandSetBase
	{
		/// <summary>
		/// Constructs a new MBRDCMDMIClipboardCommandSet.
		/// </summary>
		public MBRDCMDMIClipboardCommandSet(global::System.IServiceProvider serviceProvider)
			: base(serviceProvider)
		{
		}
	}
	...
	/// </summary>
	internal abstract partial class MBRDCMDMIClipboardCommandSetBase : DslShell::ClipboardCommandSet
	{
		/// <summary>
		/// Constructs a new MBRDCMDMIClipboardCommandSetBase.
		/// </summary>
		protected MBRDCMDMIClipboardCommandSetBase(global::System.IServiceProvider serviceProvider)
			: base(serviceProvider)
		{
		}
