...
namespace UPM_IPS.MBRDCMDMI_ProyectoIPS.MBRDCMDMI
{
	...
	/// </summary>
	internal partial class MBRDCMDMIExplorer : MBRDCMDMIExplorerBase
	{
		/// <summary>
		/// Constructs a new MBRDCMDMIExplorer.
		/// </summary>
		public MBRDCMDMIExplorer(global::System.IServiceProvider serviceProvider)
	...
	/// <summary>
	/// Control hosted in the MBRDCMDMIExplorerToolWindow.
	/// </summary>
	internal abstract class MBRDCMDMIExplorerBase : DslShell::ModelExplorerTreeContainer
	{
		/// <summary>
		/// Constructs a new MBRDCMDMIExplorerBase.
		/// </summary>
		protected MBRDCMDMIExplorerBase(global::System.IServiceProvider serviceProvider) : base(serviceProvider)
		{
		...
		protected override global::System.ComponentModel.Design.CommandID ContextMenuCommandId
		{
			get
			{
				return Constants.MBRDCMDMIExplorerMenu;
			}
		}
		...
		{
			get { return global::UPM_IPS.MBRDCMDMI_ProyectoIPS.MBRDCMDMI.TapizProyectos.DomainClassId; }
		}
