...
namespace UPM_IPS.MBRDCMDMI_ProyectoIPS.MBRDCMDMI
{
	...
	/// </summary>
	internal partial class RAToolConnectAction : DslDiagrams::ConnectAction
	{
		private DslDiagrams::ConnectionType[] connectionTypes;
		
		/// <summary>
		/// Constructs a new RAToolConnectAction for the given Diagram.
		/// </summary>
		public RAToolConnectAction(DslDiagrams::Diagram diagram): base(diagram, true) 
		{
		}
		...
		/// <summary>
		/// Returns the RAToolConnectionType associated with this action.
		/// </summary>
		protected override DslDiagrams::ConnectionType[] GetConnectionTypes(DslDiagrams::ShapeElement sourceShapeElement, DslDiagrams::ShapeElement targetShapeElement)
		{
			...
			{
				this.connectionTypes = new DslDiagrams::ConnectionType[] { new RAToolConnectionType() };
			}
			
			return this.connectionTypes;
		}
		
		private partial class RAToolConnectionTypeBase : DslDiagrams::ConnectionType
		{
			/// <summary>
			/// Constructs a new the RAToolConnectionType with the given ConnectionBuilder.
			/// </summary>
			protected RAToolConnectionTypeBase() : base() {}
		...
		private partial class RAToolConnectionType : RAToolConnectionTypeBase
		{
			/// <summary>
			/// Constructs a new the RAToolConnectionType with the given ConnectionBuilder.
			/// </summary>
			public RAToolConnectionType() : base() {}
		}
	}
}
