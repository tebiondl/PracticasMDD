...
namespace UPM_IPS.MBRDCMDMI_ProyectoIPS.MBRDCMDMI
{
	...
	/// </remarks>
	public partial class MBRDCMDMIToolboxHelper : MBRDCMDMIToolboxHelperBase 
	{
		/// <summary>
		/// Constructs a new MBRDCMDMIToolboxHelper.
		/// </summary>
		public MBRDCMDMIToolboxHelper(global::System.IServiceProvider serviceProvider)
	...
	public abstract class MBRDCMDMIToolboxHelperBase
	{
		/// <summary>
		/// Toolbox item filter string used to identify MBRDCMDMI toolbox items.  
		/// </summary>
		/// <remarks>
		...
		/// <summary>
		/// Constructs a new MBRDCMDMIToolboxHelperBase.
		/// </summary>
		protected MBRDCMDMIToolboxHelperBase(global::System.IServiceProvider serviceProvider)
		{
		...
		public static string DefaultToolboxTabName
		{
			get
			{
				return global::UPM_IPS.MBRDCMDMI_ProyectoIPS.MBRDCMDMI.MBRDCMDMIDomainModel.SingletonResourceManager.GetString("ClasesToolboxTab", global::System.Globalization.CultureInfo.CurrentUICulture);
			}
		}
		...
		protected DslModeling::Store ToolboxStore
		{
			...
			{ 
				if (toolboxStore==null)
				{
					...
					toolboxStore.LoadDomainModels(typeof(global::UPM_IPS.MBRDCMDMI_ProyectoIPS.MBRDCMDMI.MBRDCMDMIDomainModel));
