...
namespace UPM_IPS.MBRDCMDMI_ProyectoIPS.MBRDCMDMI
{
	...
	/// </remarks>
	public partial class MBRDCMDMIHelpKeywordHelper : MBRDCMDMIHelpKeywordHelperBase 
	{
		
		/// <summary>
		/// Constructs a new MBRDCMDMIHelpKeywordHelper.
		/// </summary>
		protected MBRDCMDMIHelpKeywordHelper()
			: base() { }
			
		/// <summary>
		/// Single instance of the MBRDCMDMIHelpKeywordHelper.
		/// </summary>
		public static MBRDCMDMIHelpKeywordHelper Instance
		{
			get
			{
	...
	/// </summary>
	public abstract class MBRDCMDMIHelpKeywordHelperBase
	{
		private global::System.Collections.Generic.Dictionary<string, string> helpKeywords;
		
		/// <summary>
		/// Constructs a new MBRDCMDMIHelpKeywordHelperBase.
		/// </summary>
		protected MBRDCMDMIHelpKeywordHelperBase()
			: base() { }
